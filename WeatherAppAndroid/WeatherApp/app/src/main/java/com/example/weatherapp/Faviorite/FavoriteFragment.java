...
public class FavoriteFragment extends Fragment {
    ...
    private void loadDataToView(ViewGroup rootView, FavoriteCityWeatherDTO favoriteCityWeatherDTO) {
        ...
        String timeZ= favoriteCityWeatherDTO.getTimeZone();
        ...
        for (DailyWeatherDTO dailyItem : favoriteCityWeatherDTO.getDailyWeatherDTOList()) {
            ...
            long epoch = dailyItem.getUnixtime();
            Instant instant = Instant.ofEpochSecond(epoch);
            String date = ZonedDateTime.ofInstant(instant,zoneid).format(DateTimeFormatter.ofPattern("MM/dd/uuuu"));
            Log.d("timezone", "date is: "+date);
            infoItem.setDailyDate(date);

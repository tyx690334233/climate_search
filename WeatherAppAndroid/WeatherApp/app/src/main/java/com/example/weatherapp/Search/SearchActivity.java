...
public class SearchActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (ifStored(location)) {
                    addToFav(location, fab);

                } else {
                    deleteFromFav(location, fab);
                }
            }
        });
    ...
    private void getLocationInfo(String locationString) {
        ...
        if (locationArray.length == 2) {
            ...
            Toast.makeText(SearchActivity.this,"not valid location", Toast.LENGTH_LONG).show();
        } else {
            state = locationArray[1].trim();
            country = locationArray[2].trim();
        }
        ...
        getLocationUrl += "city=" + Uri.encode(city) + "&state=" + Uri.encode(state);
    ...
    private void addToFav(String location, FloatingActionButton fab) {
    ...
    private void deleteFromFav(String location, FloatingActionButton fab) {

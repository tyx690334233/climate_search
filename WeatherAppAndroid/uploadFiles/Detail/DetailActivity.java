...
public class DetailActivity extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (item.getItemId() == R.id.twittershare) {
            ...
            String message = "Check Out "+weatherDTO.getCityName()+","+weatherDTO.getStateName()+","+weatherDTO.getCountryName()+"’s Weather! It is "+Math.round(weatherDTO.getTemperature())+"°F!" +
                    "&hashtags=CSCI571WeatherSearch";
            tweetShare.setData(Uri.parse("https://twitter.com/intent/tweet?text=" + message));//where message is your string message
    ...
    private void loadPhoto(){
        ...
        url+=Uri.parse("city="+weatherDTO.getCityName());

...
public class MainActivity extends AppCompatActivity {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        searchAutoComplete.setBackgroundColor(ContextCompat.getColor(this, R.color.colorPrimaryFont));
    ...
    public void setCurrentData(JSONObject response) {
        try {
            ...
            currentItem = loadDataToWeatherDTO(currentlyVO, dailyVO, currentItem);
    ...
    private FavoriteCityWeatherDTO loadDataToWeatherDTO(WeatherCurrentlyVO currentlyVO, WeatherDailyVO dailyVO, FavoriteCityWeatherDTO dto) {
